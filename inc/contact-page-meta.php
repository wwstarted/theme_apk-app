    ...
    <div class="vy-cm-section">
        ...
        <div class="vy-cm-row">
            ...
            <div class="vy-cm-field">
                ...
                <p class="vy-cm-hint">
                    <?php esc_html_e('Nếu trống → dùng Featured Image. Khuyến nghị: 1920×900px.', 'voya'); ?>
                </p>
    ...
    <div class="vy-cm-section">
        ...
        <div class="vy-cm-row" style="margin-bottom:16px">
            ...
            <div class="vy-cm-field">
                ...
                <p class="vy-cm-hint">
                    <?php esc_html_e('Hiển thị trong thẻ địa chỉ. Dùng Enter để xuống dòng.', 'voya'); ?>
                </p>
            </div>
...
{
    if (!isset($_POST['vy_contact_nonce']))
        return;
    if (!wp_verify_nonce($_POST['vy_contact_nonce'], 'vy_contact_meta_save'))
        return;
